...
export default function ChatDetailPage() {
  ...
  // Pega webhook que a UazAPI possa ter dropado. Silencioso, throttle 2min/lead.
  // (Em tenants de teste que reusam o mesmo número, traz o histórico do device —
  // isso é comportamento do WhatsApp/UazAPI; tenants reais usam números distintos.)
  useEffect(() => {
    if (!leadId) return;
